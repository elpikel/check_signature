defmodule CheckSignatureWeb.AnalyticsController do
  @moduledoc """
  ...
  defp req_options, do: Application.get_env(:check_signature, :analytics_req_options, [])
